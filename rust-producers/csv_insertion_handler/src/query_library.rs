...
pub fn time_series_daily_queries(file_path: String) -> (String, String, String) {
    let queries: (String, String, String) = (
        "drop table if exists landing.temp_time_series_daily".to_string()
        , "create table landing.temp_time_series_daily(daily_price_date text, symbol text, open text, high text, low text, close text, volume text, execution_time text)".to_string()
...
pub fn annual_earnings_queries(file_path: String) -> (String, String, String) {
    let queries: (String, String, String) = (
        "drop table if exists landing.temp_annual_earnings".to_string()
        , "create table landing.temp_annual_earnings(fiscal_date_ending text, symbol text, reported_earnings_per_share text, execution_time text)".to_string()
...
pub fn quarterly_earnings_queries(file_path: String) -> (String, String, String) {
    let queries: (String, String, String) = (
        "drop table if exists landing.temp_quarterly_earnings".to_string()
        , "create table landing.temp_quarterly_earnings(fiscal_date_ending text, symbol text, reported_date text, reported_earnings_per_share text, estimated_earnings_per_share text, surprise text, surprise_percentage text, execution_time text)".to_string()
...
pub fn quarterly_income_statement_queries(file_path: String) -> (String, String, String) {
    let queries: (String, String, String) = (
        "drop table if exists landing.temp_quarterly_income_statement".to_string()
        , "create table landing.temp_quarterly_income_statement(fiscal_date_ending text, symbol text, reported_currency text, gross_profit text, total_revenue text, cost_of_revenue text, cost_of_goods_and_services_sold text, operating_income text, selling_general_and_administrative text, research_and_development text, operating_expenses text, investment_income_net text, net_interest_income text, interest_income text, interest_expense text, non_interest_income text, other_non_operating_income text, depreciation text, depreciation_and_amortization text, income_before_tax text, income_tax_expense text, interest_and_dept_expense text, net_income_from_continuting_operations text, comprehensive_income_net_of_tax text, earnings_before_interest_taxes text, earnings_before_interest_taxes_depreciation_amortization text, net_income text, execution_time text)".to_string()
...
pub fn quarterly_balance_sheet_queries(file_path: String) -> (String, String, String) {
    let queries: (String, String, String) = (
        "drop table if exists landing.temp_quarterly_balance_sheet".to_string()
...
pub fn quarterly_cash_flow_queries(file_path: String) -> (String, String, String) {
    let queries: (String, String, String) = (
        "drop table if exists landing.temp_quarterly_cash_flow".to_string()
